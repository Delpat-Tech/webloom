...
export default function Header() {
  ...
  return (
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto my-4 px-3">
              ...
              <div className="flex items-center ml-auto space-x-3">
                ...
                <nav className="hidden lg:flex items-center space-x-2">
                  ...
                  <div className="relative">
                    <button
                      ...
                      className={`relative px-3 py-2 rounded-md text-sm font-medium transition-all duration-300 group bg-muted/40 backdrop-blur-md border border-border/80 text-muted-foreground hover:text-foreground flex items-center gap-1 ${
                    ...
                    {collabOpen && (
                      <div
                        ...
                        role="menu"
                        tabIndex={-1}
                        className="absolute right-0 mt-2 w-48 rounded-md shadow-lg bg-[var(--card)] dark:bg-[var(--background)] border border-border z-50 py-1 animate-fade-in"
                      >
                        <Link
                          href="/contact"
                          className={`block px-4 py-2 text-sm rounded-md transition-colors duration-200 bg-[var(--muted)] dark:bg-[var(--muted)] hover:bg-muted/60 ${
                            pathname === "/contact"
                ...
                {mounted && (
                  <button
                    ...
                    className="p-1 rounded-md bg-muted/40 backdrop-blur-md border border-border/80 hover:bg-muted/60 transition-colors text-muted-foreground focus:outline-none focus:ring-2 focus:ring-primary"
                  >
                    {isDark ? (
                ...
                {/* Mobile menu button */}
                <button
                  className="lg:hidden p-2 rounded-md bg-muted/40 backdrop-blur-md border border-border/80 hover:bg-muted/60 transition-colors text-muted-foreground"
                ...
                <nav className="flex flex-col space-y-2">
                  ...
                  <div className="relative">
                    <button
                      ...
                      className={`w-full flex items-center justify-between px-4 py-3 rounded-md text-base font-medium transition-all duration-300 bg-[var(--muted)] dark:bg-[var(--muted)]
