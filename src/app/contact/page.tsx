  ...
  const qualificationQuestions = [
    {
      ...
      description: 'You have proof of concept, early users, or market validation',
  ...
  const successStories = [
    {
      ...
      solution: 'Built full-stack SaaS platform with user management & analytics',
      ...
      <section className="relative px-6 md:px-12 lg:px-20 py-24 md:py-32 min-h-screen flex items-center">
        <div className="max-w-7xl mx-auto w-full">
          ...
          >
            ...
            >
              {[
                { icon: <Lightbulb className="w-5 h-5" />, text: 'Validated Idea?', subtext: 'Need MVP fast' },
                { icon: <Settings className="w-5 h-5" />, text: 'Manual Processes?', subtext: 'Ready to automate' },
                { icon: <Target className="w-5 h-5" />, text: '₹40k+ Budget?', subtext: '6-week timeline' }
              ].map((item, index) => (
                <motion.div
                  key={index}
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Real results from founders and ops leaders who trusted us with their execution.
            </p>
          </motion.div>
              ...
              >
                ...
                <div className="flex items-center justify-between pt-4 border-t border-border">
                  <div className="text-center">
                    <div className="text-lg font-bold text-primary">{story.timeline}</div>
                    <div className="text-xs text-muted-foreground">Timeline</div>
                  </div>
                  <div className="text-center">
                    <div className="text-lg font-bold text-primary">{story.budget}</div>
        ...
        <section className="relative px-6 md:px-12 lg:px-20 py-20">
          ...
          >
            <motion.div
              ...
              <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
                Whether you prefer a detailed discussion or a quick chat, we&apos;re here to help.
              </p>
            </motion.div>
              ...
              {contactMethods.map((method, index) => (
                ...
                >
                  <div className={`inline-flex items-center justify-center w-12 h-12 rounded-xl mb-4 ${
                    ...
                    <div className={method.primary ? 'text-white' : 'text-primary'}>
                      {method.icon}
                    </div>
                  </div>
