...
export default function PartnerPageClient({ testimonials }: PartnerPageClientProps) {
      ...
      <div className="fixed inset-0 -z-10">
        ...
        <motion.div
          ...
          animate={
            shouldReduceMotion
              ? undefined
              : { x: mousePosition.x - 192, y: mousePosition.y - 192, scale: [1, 1.1, 1] }
          }
          transition={
            shouldReduceMotion
              ? undefined
          ...
          >
            <div className="relative mb-8">
              <motion.div
                ...
                animate={shouldReduceMotion ? undefined : { y: [0, -30, 0], rotate: [0, 15, 0], scale: [1, 1.1, 1] }}
              ...
              <motion.div
                ...
                animate={shouldReduceMotion ? undefined : { y: [0, -25, 0], rotate: [0, -12, 0], scale: [1.1, 1, 1.1] }}
                transition={shouldReduceMotion ? undefined : { duration: 5.5, repeat: Infinity, ease: 'easeInOut', delay: 2.5 }}
              >
                <Users className="w-20 h-20" />
              </motion.div>
              <motion.div
                className="absolute -bottom-12 left-1/4 text-accent/40"
                animate={shouldReduceMotion ? undefined : { y: [0, -20, 0], rotate: [0, 20, 0], scale: [1, 1.15, 1] }}
                transition={shouldReduceMotion ? undefined : { duration: 5.2, repeat: Infinity, ease: 'easeInOut', delay: 1.5 }}
              >
            ...
            >
              For agencies &amp; studios: Do you design, but don&apos;t build? We provide reliable, white-label
              development services that make you look amazing.
            </motion.p>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              We become your invisible development team, delivering quality work that enhances your reputation
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {partnershipBenefits.map((benefit, index) => (
              <SimpleCard key={index} className="flex flex-col gap-4 h-full">
                ...
                <p className="text-muted-foreground leading-relaxed mb-2">{benefit.description}</p>
              </SimpleCard>
            ))}
          </div>
        </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              {testimonials.map((testimonial, index) => (
                <SimpleCard
                  ...
                  className="relative overflow-hidden flex flex-col gap-5 h-full group transition-all duration-300 hover:-translate-y-1 hover:shadow-xl"
                >
      ...
      <section className="relative px-6 md:px-12 lg:px-20 py-16 border-t border-border">
        <div className="max-w-4xl mx-auto text-center">
          <motion.div
            ...
            transition={{ duration: 0.8 }}
          >
            <h3 className="text-2xl md:text-3xl font-bold text-foreground mb-6">Prefer a Quick Chat?</h3>
