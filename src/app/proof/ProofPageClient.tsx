      ...
      <section className="relative px-6 md:px-12 lg:px-20 py-24 md:py-32 min-h-screen flex items-center">
        <div className="max-w-7xl mx-auto w-full">
          ...
          >
            ...
            >
              We don&apos;t talk, we ship. Explore the MVPs, internal tools, and automations we&apos;ve built
              for founders and ops leaders who needed results, fast.
            </motion.p>
                  ...
                  <div className="flex-1 space-y-6">
                    ...
                    <div className="flex items-center gap-4">
                      <div className="w-16 h-16 rounded-full bg-gradient-to-br from-primary to-accent flex items-center justify-center overflow-hidden">
                        {testimonial.photoUrl ? (
                          ...
                          <img src={testimonial.photoUrl} alt={testimonial.clientName} className="w-full h-full object-cover" />
                        ) : (
                    ...
                    {testimonial.context && (
                      <div className="flex flex-wrap gap-3">
                        {testimonial.context.split('·').map((item, idx) => (
